...
public class PEMEncodedKeyParserTest {
    ...
    public void loadCertificate() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.EC_CERT_PEM);
    ...
    public void loadPrivateKey() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.EC_PRIVATE_KEY_PEM);
    ...
    public void loadPublicKey() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.EC_PUBLIC_KEY_PEM);
        final ECPublicKey key = (ECPublicKey) credential.get(0).getPublic();
        assertNotNull(key);
    ...
    public void loadRsaCertificate() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.RSA_CERT_PEM);
    ...
    public void loadRsaPrivateKey() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.RSA_PRIVATE_KEY_PEM);
    ...
    public void loadRsaPublicKey() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys(SamplePEMEncodedObjects.RSA_PUBLIC_KEY_PEM);
        final RSAPublicKey key = (RSAPublicKey) credential.get(0).getPublic();
        assertNotNull(key);
    }
    ...
    public void loadEmptyKey() throws Exception {
        final List<KeyPair> credential = PEMEncodedKeyParser.parsePemKeys("");
